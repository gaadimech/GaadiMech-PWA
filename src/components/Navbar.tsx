      ...
      {isOpen && (
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="block px-3 py-2 text-gray-700 hover:text-[#FF7200]">Home</Link>
            <Link to="/services" className="block px-3 py-2 text-gray-700 hover:text-[#FF7200]">Services</Link>
            <Link to="/about" className="block px-3 py-2 text-gray-700 hover:text-[#FF7200]">About</Link>
            <Link to="/blog" className="block px-3 py-2 text-gray-700 hover:text-[#FF7200]">Blog</Link>
            <Link to="/contact" className="block px-3 py-2 text-gray-700 hover:text-[#FF7200]">Contact</Link>
            <button
              onClick={handleBookNow}
