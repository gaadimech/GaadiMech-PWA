          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <div className="inline-block mb-4 relative">
                ...
                <div className="relative bg-gradient-to-r from-[#FF7200] to-[#FF9500] px-4 py-1 rounded-lg shadow-md">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-white font-bold text-sm uppercase tracking-wider">Expert Repair</span>
                  </div>
                </div>
              </div>
              ...
              <p className="text-base md:text-lg text-gray-600 mb-6">
                Professional car repair services in Jaipur with expert mechanics and genuine parts for all makes and models.
              </p>
              ...
              >
                ...
                >
                  ...
                  <p className="ml-3 text-lg font-medium text-gray-700">
                    <span className="text-[#FF7200] font-bold">Expert</span> Certified Mechanics
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="ml-3 text-lg font-medium text-gray-700">
                    <span className="text-[#FF7200] font-bold">Genuine</span> Spare Parts
                  </p>
                </motion.div>
              </motion.div>
