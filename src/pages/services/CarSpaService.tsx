...
const features = [
  { name: "Exterior wash and wax", icon: <Droplets className="w-5 h-5 text-[#FF7200]" /> },
  { name: "Interior deep cleaning", icon: <Car className="w-5 h-5 text-[#FF7200]" /> },
  { name: "Upholstery cleaning", icon: <Brush className="w-5 h-5 text-[#FF7200]" /> },
  { name: "Dashboard polishing", icon: <Sparkles className="w-5 h-5 text-[#FF7200]" /> },
  { name: "Wheel and tire cleaning", icon: <Car className="w-5 h-5 text-[#FF7200]" /> },
  { name: "Glass cleaning", icon: <Shield className="w-5 h-5 text-[#FF7200]" /> },
  { name: "Engine bay cleaning", icon: <Wrench className="w-5 h-5 text-[#FF7200]" /> },
  { name: "Paint protection", icon: <Shield className="w-5 h-5 text-[#FF7200]" /> }
];

// Service benefits with icons
const benefits = [
  { title: "Quality Service", description: "Premium products & expert technicians", icon: <Award className="w-12 h-12 text-[#FF7200]" /> },
  { title: "Time Efficient", description: "Quick turnaround times", icon: <Clock className="w-12 h-12 text-[#FF7200]" /> },
...
const CarSpaService = () => {
  ...
  const handleGetPrices = (packageName?: string) => {
    let message = 'Hi%2C%20I%27d%20like%20to%20know%20the%20prices%20for%20Car%20Cleaning%20Service';
    if (packageName) {
  ...
  const handleBookAppointment = () => {
    window.open(`https://wa.me/917300042410?text=I%27d%20like%20to%20book%20a%20Car%20Cleaning%20Service.`, '_blank');
  };

  const serviceReviews = getReviewsByService('car_spa');
  ...
  return (
    ...
    >
      <Helmet>
        <title>Car Spa & Cleaning Services | GaadiMech</title>
        <meta name="description" content="Professional car cleaning and detailing services. Get your car looking brand new with our expert cleaning solutions." />
      </Helmet>
      ...
      <div className="relative h-[90vh] sm:h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black">
          ...
          {/* Wheel shapes */}
          <div className="absolute bottom-[10%] right-[15%] md:right-[25%] w-[10vh] h-[10vh] rounded-full border-4 border-[#FF7200]/30 bg-gradient-to-br from-gray-900 to-black"></div>
          <div className="absolute bottom-[10%] right-[40%] md:right-[50%] w-[10vh] h-[10vh] rounded-full border-4 border-[#FF7200]/30 bg-gradient-to-br from-gray-900 to-black"></div>
        ...
        {/* Floating bubbles/water drops animation */}
            ...
            >
              <div className="flex justify-center mb-6">
                <div className="bg-white/10 backdrop-blur-md p-5 rounded-full shadow-lg shadow-orange-500/20">
                  <img
                    src="https://i.ibb.co/54mCj9R/Group-1.png"
                    alt="Car Spa Service"
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white drop-shadow-lg">
                <span className="text-[#FF7200]">Car Spa</span> & Cleaning Services
              </h1>
              <div className="bg-black/30 backdrop-blur-sm py-3 px-6 rounded-full inline-block">
                <p className="text-xl text-white max-w-2xl mx-auto">
                  Professional cleaning for the ultimate showroom shine
                </p>
              </div>
            </motion.div>
      ...
      <div id="main-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          {activeTab === 'about' && (
            ...
            >
              <motion.div variants={itemVariants}>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Complete Car Care</h2>
                <p className="text-gray-700 mb-6 text-lg">
                  Give your car the pampering it deserves with our comprehensive cleaning services.
                  We use premium products and professional techniques for the best results that last longer.
                </p>
              ...
              <motion.div variants={itemVariants} className="relative h-full">
                <div className="relative aspect-w-4 aspect-h-3 rounded-xl overflow-hidden shadow-xl">
                  <img 
                    src="https://i.ibb.co/twHz6hJ9/Car-Wash-1.jpg" 
                    alt="Car washing before and after" 
                ...
                <div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-lg shadow-lg hidden md:block">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">For your car's beauty</p>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          {activeTab === 'packages' && (
            ...
            >
              ...
              >
                Choose Your Perfect Car Spa Package
              </motion.h2>
        ...
        <div className="relative bg-gradient-to-r from-[#FF7200] to-[#FF9500] rounded-xl p-8 mb-16 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Ready to give your car the spa treatment it deserves?</h3>
              <p className="text-white/90 mb-6">
                Book your appointment today and experience the GaadiMech difference. Our expert technicians use premium products for perfect results every time.
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              {
                question: "How long does the car spa service take?",
                answer: "Our basic car spa typically takes 1-2 hours, while premium and luxury spa services may take 3-4 hours depending on the vehicle size and condition."
              },
              {
                question: "What products do you use?",
                answer: "We use professional-grade, eco-friendly cleaning products that are safe for your vehicle's paint, interior materials, and the environment."
              },
              {
                question: "How often should I get a car spa?",
                answer: "For best results, we recommend a basic car spa every 2-4 weeks and a premium or luxury spa every 3-6 months depending on usage and environmental conditions."
              },
              {
                question: "Do you offer mobile car spa services?",
                answer: "Yes, we provide doorstep car spa services in select areas. Contact us for availability in your location and to schedule a convenient appointment."
              }
            ].map((faq, index) => (
              <motion.div 
                key={index}
