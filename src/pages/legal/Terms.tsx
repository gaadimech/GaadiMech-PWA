    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-sm max-w-none">
          ...
          <p>
            "User" or "You" shall mean any individual who owns a car (primarily out of the manufacture warranty period) in urban centers especially metros, who is desirous of availing Services on the Platform as and who are registered on the Platform for this purpose.
          </p>

          <h2 className="text-xl font-bold">3. SERVICES</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">5. USE OF SERVICES</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">6. SUPPORT</h2>
          <p>
            The Company offers an email as well as phone call based support system along with an online knowledge pool of FAQs. In case you require any assistance or support, you may access support resources or contact our support by emailing at contact@gaadimech.com or calling our helpline at [8448285289] (Monday to Sunday between 7 am and 9 pm).
          </p>
          <p>
          ...
          <h2 className="text-xl font-bold">7. PROHIBITED USAGE OF THE PLATFORM</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">8. USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">9. USER DATA</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">10. INTELLECTUAL PROPERTY RIGHTS</h2>
          <p>
          ...
          <p>
            You acknowledge and agree that through your use of the Platform or by availing any Services through or at the Platform, no right (express or implied) is granted to you in respect of such Content. The Company reserves the right to change or modify the Content from time to time at its sole discretion.
          </p>

          <h2 className="text-xl font-bold">11. LICENSE</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">13. EXEMPTIONS TO LIABILITY OF COMPANY</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">14. BILLING/CHARGES</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">15. CANCELLATION AND REFUND</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">19. TERMINATION</h2>
          <p>
          ...
          <h2 className="text-xl font-bold">21. CONTACTING YOU</h2>
          <p>
          ...
          <div className="mt-8 text-sm text-gray-600">
            ...
            <p>Email: contact@gaadimech.com</p>
